...
import com.websharp.websharputil.BuildConfig;
...
public class LogUtil {
	public static String TAG = "Websharp";

	public static final boolean LOG_ENABLED = BuildConfig.DEBUG;

	//sdk目录platform-tools 下执行命令 adb shell setprop log.tag.Websharp VERBOSE
	...
	private static String buildMessage(String format, Object... args) {
		String msg = (args == null || args.length < 1) ? format : String
