...
public class RollingCycle extends ViewGroup {
	...
	public boolean isCanRolling = true;
	...
	private void initView() {
		...
		/*
		 * Button b1 = new Button(getContext()); b1.setText("b1"); LayoutParams
		 * params = new LayoutParams(LayoutParams.WRAP_CONTENT,
		 * LayoutParams.WRAP_CONTENT); b1.setLayoutParams(params); addView(b1);
		 * 
		 * Button b2 = new Button(getContext()); b2.setText("b2"); LayoutParams
		 * params2 = new LayoutParams(LayoutParams.WRAP_CONTENT,
		 * LayoutParams.WRAP_CONTENT); b2.setLayoutParams(params2); addView(b2);
		 * 
		 * Button b3 = new Button(getContext()); b3.setText("b3"); LayoutParams
		 * params3 = new LayoutParams(LayoutParams.WRAP_CONTENT,
		 * LayoutParams.WRAP_CONTENT); b3.setLayoutParams(params3); addView(b3);
		 */
	...
	private void snapToScreen(int whichScreen, int velocity, boolean settle) {
		...
		if (screenListener != null) {
			if (whichScreen != mCurrentScreen) {
				if (delta > 0) {
					if ((screenIndex + 1) > (getChildCount() - 1))
						screenIndex = 0;
					else
						screenIndex++;
				} else {
					if ((screenIndex - 1) < 0)
						screenIndex = getChildCount() - 1;
					else
						screenIndex--;
				}
				screenListener.OnScreenChanged(screenIndex, getChildCount());
			}
		}
	}
	...
	public interface OnScreenChangedListener {
		public void OnScreenChanged(int curScreen, int totalScreen);
	}
