...
public class ImageViewCircle extends ImageView {
	...
	public ImageViewCircle(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.ImageViewCircle, defStyle, 0);

		mBorderWidth = a.getDimensionPixelSize(
				R.styleable.ImageViewCircle_border_width, DEFAULT_BORDER_WIDTH);
		mBorderColor = a.getColor(R.styleable.ImageViewCircle_border_color,
